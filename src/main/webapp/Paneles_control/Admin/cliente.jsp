	...
	<footer
		...
		<div class="container">
			<footer class="py-3 my-4">
				...
				<p class="text-center text-body-secondary">2024 Garbugunne, Inc</p>
			</footer>
		</div>
	</footer>
	<script
		...
		<div class="sidebar aside">
			...
			<ul class="nav nav-pills flex-column mb-auto">
				<li class="nav-item"><a
					...
					class="nav-link disabled" aria-current="page"> PROVEEDORES </a></li>
				<li><a
					href="http://localhost:8080/Garbigune_reto/admin?peticion=planta "
					class="nav-link "> PLANTAS </a></li>
				<li><a href="Paneles_control/Admin/suministro.jsp"
					class="nav-link disabled"> SUMINISTROS </a></li>
				<li><a
					href="http://localhost:8080/Garbigune_reto/admin?peticion=materiales"
					class="nav-link "> MATERIALES </a></li>
				<li><a href="Paneles_control/Admin/productos_Admin.jsp"
					class="nav-link disabled"> PRODUCTOS </a></li>
				<li><a href="#" class="nav-link disabled"> EMISIONES POR
						PRODUCTO </a></li>
								...
								<td class="d-flex flex-wrap justify-content-evenly w-2">
									<div class="btn-group" role="group" aria-label="Basic example">
										<button type="button" class="btn btn-flex trash">
											<a
												href="/Garbigune_reto/eliminarMaterial?id=${cliente.id_cliente}"
												class="btn btn-flex trash"> <i
												class="bi bi-trash text-light fs-5 text-info"></i>
											</a>
										</button>
							...
							<div class="modal-body">
								<form action="http://localhost:8080/Garbigune_reto/create"
									...
									<div class="mb-3">
										<label for="exampleInput" class="form-label">Apellido</label>
										<input type="text" class="form-control" id="exampleInput"
											aria-describedby="emailHelp" name="apellido">
									</div>
									<div class="mb-3">
										<label for="exampleInput" class="form-label">Usuario</label> <input
											type="text" class="form-control" id="exampleInput"
