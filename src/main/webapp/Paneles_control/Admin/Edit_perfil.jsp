					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="/Garbigune_reto/UpdateClientes" method="post">
								<input type="text" class="form-control d-none" name="id_cliente"
									value="${id_cliente}"> <input type="text"
									class="form-control d-none" name="opcion" value="cliente">
								<input type="text" class="form-control d-none" name="peticion"
									value="usuario"> <input type="text"
									class="form-control d-none" name="opcion" value="cliente">
