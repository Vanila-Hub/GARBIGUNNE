...
<body>
		...
		<div class="sidebar aside">
			...
			<ul class="nav nav-pills flex-column mb-auto">
				<li class="nav-item"><a href="/Garbigune_reto/VerProveedores"
					class="nav-link active" aria-current="page"> PROVEEDORES <i
								...
								<td class="d-flex flex-wrap justify-content-evenly w-2">
									<div class="btn-group" role="group" aria-label="Basic example">
										<button type="button" class="btn btn-flex"
											...
											<a
												href="/Garbigune_reto/editarProveedor?id_proveedor=${proveedor.id_proveedor}"><i
												class="bi bi-pencil-square fs-5 text-light"></i></a>
										</button>
										<a
											href="/Garbigune_reto/borrarProveedor?id_proveedor=${proveedor.id_proveedor}"
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="/Garbigune_reto/crearProveedor" method="post">
									...
									<div class="mb-3">
										<label for="exampleInput" class="form-label">correo</label> <input
	...
	<div class="modal fade" id="vewOne" tabindex="-1"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form action="http://localhost:8080/Garbigune_reto/create"
						method="post">
						<input type="text d-none" class="form-control" name=opcion
							" value="proveedor">
						<div class="mb-3">
							<label for="exampleInput" class="form-label">Nombre</label> <input
