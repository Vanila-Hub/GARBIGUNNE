...
<head>
    ...
    <link rel="shortcut icon" href="Login/img/logo_garbigunne.png" type="image/x-icon">
...
<body>
    ...
    <main>
       <div class="contenedor">
        <form action="/Garbigune_reto/acces" method="get">
            <div class="mb-3">
            ...
            <button type="button" class="btn btn-secondary"><a href="/Garbigune_reto/registrarse"> Registrarse</a></button>
          </form>
       </div>
    </main>
